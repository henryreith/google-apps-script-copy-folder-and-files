...
* **Copies *All* File Types:** No-code tools often can't copy non-Google files (like .zip, .psd, or .mp4 templates). This script copies *all* files, including binary assets and Google Docs, preserving them perfectly - so you can prefill sheets, or docs with data in your template folder, and it will be all copied over as is.
